...
![WERSI CX-5 Back Panel](back.png)
...
![Front Panel – Basic Configuration](buttons.png)
...
![Front Panel – Full Configuration](buttons.png)
...
![Display and Pad Layout](screen.png)
...
![Front Panel – Sequencer](buttons.png)
...
| 5   | EDIT                                | - With **2nd Function**: enters **name edit mode** for user rhythms (6-character names)                    | - [Editing Rhythm Names](#editing-rhythm-names) |
| 6   | F‑RH / CART (depending on version)  | - In many software versions: selects **Cartridge rhythm/sequence group** (“Cart”)<br>- In others: toggles **Fixed Rhythm Group 1/2** together with SELECTOR | - [Basic Configuration – Selector](#selector)<br>- [Cart (Playing from Cartridge)](#playing-from-cartridge) |
| 7   | F‑RH 1 (Fixed Rhythm Group 1)       | Selects **factory rhythm group 1** (upper printed rhythm names)                                           | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm) |
...
|-----|-------------------------------------|-----------------------------------------------------------------------------------------------------------|-----------------------|
| 12  | EFFECT SEL                          | Toggles **Sound Effect Group 1/2** (Crash/Thriller/Clap ↔ Hey/Aha/Synthe Drum) and also enters **Pad Assignment** mode when used after PAD/MIDI | - [Sound Effects](#sound-effects)<br>- [Assigning Instruments to Pad Presets](#assigning-instruments-to-pad-presets) |
| 13  | MAN. RH. (Manual Rhythm)            | Enables/disables **Manual Rhythm**: rhythm buttons become direct instrument triggers                      | - [Manual Rhythm (Man. Rh.)](#manual-rhythm-man-rh) |
| 14  | SNARE ROLL                          | Triggers a **snare drum roll**, also during running rhythm                                                | - [Snare Roll](#snare-roll) |
| 15  | COPIER / Rhythm / Pad / Numeric key | - Normal: one of the **rhythm selection buttons**<br>- In **Program**: used as part of numeric/time-signature entry and instrument selection<br>- With **2nd Function**: used with **Copier** function to copy rhythms | - [Copying Rhythms](#copying-rhythms)<br>- [Entering Time Signature](#entering-time-signature)<br>- [Playing Instruments](#playing-instruments) |
| 16  | WR. CART. / Rhythm key              | - With **2nd Function**: starts **Write Cartridge (Wr. Cart.)** operation (copies RAM → cartridge)<br>- Also acts as rhythm / pad / numeric key as above | - [Write Cartridge (Wr. Cart.)](#write-cartridge-wr-cart)<br>- [Entering Time Signature](#entering-time-signature) |
| 17  | RD. CART. / Rhythm key              | - With **2nd Function**: starts **Read Cartridge (Rd. Cart.)** (copies cartridge → RAM)<br>- Also used as rhythm / numeric key | - [Read Cartridge (Rd. Cart.)](#read-cartridge-rd-cart)<br>- [Entering Time Signature](#entering-time-signature) |
| 18  | RHYTHM / Numeric key                | Generic **multi-function key**:<br>- Rhythm selection in basic use<br>- Time-signature step value in programming<br>- Character / number key in name edit | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Entering Time Signature](#entering-time-signature)<br>- [Editing Rhythm Names](#editing-rhythm-names) |
| 19  | RHYTHM / Numeric key                | Same as 18 – used for **rhythm selection**, **time signatures** (e.g. 5/4), and in **editing** modes      | - [Entering Time Signature](#entering-time-signature) |
| 20  | RHYTHM / Numeric key                | Same as 18 – includes **value 6** for 6/8 time and other numeric/programming uses                         | - [Entering Time Signature](#entering-time-signature) |
| 21  | RHYTHM / Numeric key                | Same as 18 – rhythm selector / numeric / character key depending on active mode                           | - [Playing Instruments](#playing-instruments)<br>- [Editing Rhythm Names](#editing-rhythm-names) |
| 22  | RHYTHM / Numeric key                | Same as 18 – last key in the upper rhythm row, also used in sequences and MIDI channel selection          | - [Programming Sequences](#programming-sequences)<br>- [Setting TX/RX Channels](#setting-transmit-and-receive-channels) |
...
| Btn | Panel Label(s)                      | Main Function(s)                                                                                          | Detailed instructions |
|-----|-------------------------------------|-----------------------------------------------------------------------------------------------------------|-----------------------|
| 24  | CRASH CYM / C. LOAD                 | - Normal: triggers **Crash Cymbal** (or “Hey” in Effect Group 2)<br>- With **2nd Function**: **Cassette Load (C. Load)** | - [Sound Effects](#sound-effects)<br>- [Cassette Load](#cassette-load) |
| 25  | THRILLER / C. CHECK                 | - Normal: triggers **Thriller** sound (or “Aha” in Group 2)<br>- With **2nd Function**: **Cassette Check (C. Check)** | - [Sound Effects](#sound-effects)<br>- [Cassette Check](#cassette-check) |
| 26  | CLAP / C. SAVE                      | - Normal: triggers **Handclap** (or **Synthe Drum** in Group 2)<br>- With **2nd Function**: **Cassette Save (C. Save)** | - [Sound Effects](#sound-effects)<br>- [Cassette Save](#cassette-save) |
| 27  | DISCO 1 / Pad / Rhythm key          | - Normal: rhythm **“Disco 1”** (or alternate via Selector)<br>- In Pad modes: pad select / pad preset number<br>- In programming: part of numeric / bar-count entry | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Programming Sequences](#programming-sequences)<br>- [Assigning Instruments to Pad Presets](#assigninginstruments-to-pad-presets) |
| 28  | DISCO 2 / REGGAE / Pad key          | - Normal: rhythm (e.g. **Disco 2**, **Reggae 1** depending on group)<br>- In edit modes: character/number key | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Editing Rhythm Names](#editing-rhythm-names) |
| 29  | DISCO 3 / ROCK / Pad key            | - Normal: rhythm (e.g. **Disco 3**, **Rock 1/2** depending on group)<br>- Also used as multi-purpose key in programming | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Programming Sequences](#programming-sequences) |
| 30  | BEAT / REGGAE / Pad key             | - Normal: rhythm (Beat / Reggae / Twist, depending on group & software)<br>- Also used for pad / MIDI selections | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Activating Pad Mode](#activating-pad-mode) |
| 31  | ROCK / TANGO / Pad key             | - Normal: rhythm (Rock, Tango, etc. depending on group)<br>- Multi-function in Program / Pad / MIDI modes  | - [Basic Configuration – Changing the Rhythm](#changing-rhythms)<br>- [Programming Sequences](#programming-sequences) |
| 32  | REGGAE / MARCH / Pad key           | - Normal: rhythm (Reggae 2, March 1, etc., depending on group)<br>- Also used as sequence / preset selector | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Programming Sequences](#programming-sequences) |
| 33  | TWIST / 6/8 MARCH / Pad key        | - Normal: rhythm (Twist 1/2, 6/8 March, etc.)<br>- Often used for special meter patterns in sequences      | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Programming Sequences](#programming-sequences) |
| 34  | TANGO / MARCH 2 / Pad key          | - Normal: rhythm (Tango, March 2, etc.)<br>- Also used as **space** or numeric key in naming / MIDI channel selection | - [Selecting and Starting a Rhythm](#selecting-and-starting-a-rhythm)<br>- [Editing Rhythm Names](#editing-rhythm-names)<br>- [Setting TX/RX Channels](#setting-transmit-and-receive-channels) |
